            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="nav nav-tabs search1">
                        ...
                        <li>
                        <!-- Box -->
                        <a  data-toggle="" href="#tour" class="category-small-box">
                        ...
                        <li>
                        <!-- Box -->
                        <a data-toggle="" href="{{route('search.hotel')}}" class="category-small-box">
                        ...
                        <li>
                        <!-- Box -->
                        <a data-toggle="" href="{{route('flights')}}" class="category-small-box">
                        ...
                        <li class="active">
                        <!-- Box -->
                        <a data-toggle="" href="{{route('recharge.home')}}" class="category-small-box">
